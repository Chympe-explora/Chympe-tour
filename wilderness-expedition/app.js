...
(function () {
  ...
  function App() {
    ...
    // ---- Live 10-second "waiting for your guide" countdown ---------------
    ...
    // the 10-second countdown above runs out while still pending. Fully
    ...
    var normalStatusCard = h(
      ...
      // Live 1→10 countdown while pending — ticks down every second and
      // hands off to noResponseCard above the moment it hits 0.
      bookingStatus === "pending" && h(
        "p", { className: "mt-2 text-[12px] text-white/40" },
        "Checking with your guide… ", countdown, "s"
      ),
      ...
      bookingStatus === "cancelled" && h(
        "p", { className: "mt-4 text-[12px] text-amber-300" }, "Chat with us to sort this out."
      ),
      h(
        "div", { className: "mt-6 flex flex-col gap-3" },
        h(
